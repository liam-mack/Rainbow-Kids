...
export const programObjFour= { 
    ...
    lightTextDescription: false,
    headline: "Nutrition",
    description: "We provide a nutritious mid-day meal for the preschool children prepared onsite.",
    description2: "Nutritious snacks are served daily; one in the morning program, and one in each of the afternoon programs. The snack menu is posted in advance of the parent bulletin board. Should circumstances (allergy/dieatry restriction) prevent a child from having a particular snack, the centre will provide a substitute.",
